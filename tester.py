...
class Background:
    ...
    def run(self):
        ...
        while running:# Game loop########################################################
            ...
            screen.blit(self.background_image, (self.bgx + self.bg_width, 0))#changed from background_image2 to background_image to make it loop the same image instead of switching between 2 images
            #no need for 2nd background image if we just loop the same one, also makes it look more seamless but it can clearly see the difference when png is looped but not jumpy like previous 
